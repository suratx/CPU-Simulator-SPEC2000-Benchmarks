...
sed -n 149p benchCrafty.txt >> crafty_ans.txt
sed -n 197p benchCrafty.txt >> crafty_ans.txt
sed -n 207p benchCrafty.txt >> crafty_ans.txt
sed -n 209p benchCrafty.txt >> crafty_ans.txt
sed -n 217p benchCrafty.txt >> crafty_ans.txt
sed -n 219p benchCrafty.txt >> crafty_ans.txt
sed -n 145p benchCrafty.txt >> crafty_ans.txt
sed -n 146p benchCrafty.txt >> crafty_ans.txt
sed -n 148p benchCrafty.txt >> crafty_ans.txt
